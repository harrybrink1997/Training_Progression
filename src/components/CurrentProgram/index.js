...
class CurrentProgramPage extends Component {
    ...
    setAvailExerciseChartData = (exerciseList) => {
        ...
        exerciseList.forEach(exercise => {
            tableData.push({
                ...
                addExerciseBtn: <AddExerciseModal submitHandler={this.handleAddExerciseButton} name={exercise.uid} primaryMusc={exercise.primary} />
    ...
    handleDeleteExerciseButton = async (event) => {
        ...
        if (exUid in this.exerciseDataChanges) {
            delete this.exerciseDataChanges[exUid]
        }
